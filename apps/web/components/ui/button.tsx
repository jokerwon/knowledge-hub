...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        // button-primary — lavender CTA. Hover lifts to #828fff, pressed settles on #5e69d1.
        default:
          "bg-primary text-primary-foreground hover:bg-primary-hover active:bg-primary-focus",
        // button-secondary — charcoal panel with a hairline border.
        secondary:
          "border-hairline bg-surface-1 text-ink hover:bg-surface-2 aria-expanded:bg-surface-2 aria-expanded:text-ink",
        outline:
          "border-hairline bg-transparent text-ink hover:bg-surface-2 hover:text-ink aria-expanded:bg-surface-2 aria-expanded:text-ink",
        // button-tertiary — plain text button on the canvas.
        ghost:
          "bg-transparent text-ink hover:bg-surface-2 aria-expanded:bg-surface-2 aria-expanded:text-ink",
        destructive:
          "bg-destructive/10 text-destructive hover:bg-destructive/20 focus-visible:border-destructive/40 focus-visible:ring-destructive/20",
        link: "text-primary underline-offset-4 hover:underline",
        // button-inverse — white pill CTA for section openers.
        inverse:
      ...
      size: {
        ...
        // Marketing CTA size — holds the ≥40px touch target required across viewports.
